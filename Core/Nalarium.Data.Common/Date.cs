...
namespace Nalarium.Data.Common
{
    ...
    public static class Date
    {
        ...
        static Date()
        {
            ResourceAccessor.RegisterResourceManager(AssemblyInfo.AssemblyName, new String[] { "en" });
        }
        ...
        public static Int32StringMap GetMonthData()
        {
            if (!CachedDataFactory.Exists(Info.Scope, Culture.TwoCharacterCultureCode, Info.Month))
            {
                ...
                //+
                CachedDataFactory.Register<Int32StringMap>(Info.Scope, Culture.TwoCharacterCultureCode, Info.Month, map);
            }
            //+
        ...
        public static Int32StringMap GetDayData()
        {
            if (!CachedDataFactory.Exists(Info.Scope, Culture.TwoCharacterCultureCode, Info.Day))
            {
                ...
                //+
                CachedDataFactory.Register<Int32StringMap>(Info.Scope, Culture.TwoCharacterCultureCode, Info.Day, map);
            }
            //+
